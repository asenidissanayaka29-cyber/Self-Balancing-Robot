...
#define SETPOINT_PITCH_ANGLE_OFFSET -3.0
...
#define PID_PITCH_KP 75  // more power to correct tilt
#define PID_PITCH_KI 15    // reduced integral so it doesn’t keep tilting
#define PID_PITCH_KD 3    // more damping to stop fast falling
...
// ----- FORWARD -----
if (btCommand == '1') {
  setpointPitchAngle += 0.001;   // slow tilt forward
  setpointPitchAngle = constrain(setpointPitchAngle,
                                 SETPOINT_PITCH_ANGLE_OFFSET,
                                 SETPOINT_PITCH_ANGLE_OFFSET + 0.2);
}

// ----- BACKWARD -----
else if (btCommand == '2') {
  setpointPitchAngle -= 0.001;   // slow tilt backward
  setpointPitchAngle = constrain(setpointPitchAngle,
                                 SETPOINT_PITCH_ANGLE_OFFSET - 0.2,
                                 SETPOINT_PITCH_ANGLE_OFFSET);
}
